...
import com.code.db.code_db.dtos.ContattiDto;
...
public class ContattiBaseController {
 ...
 */
	...
	private ContattiDto convertToDto(Contatti contatti) {
		ContattiDto contattiDto = modelMapper.map(contatti, ContattiDto.class);
		return contattiDto;
	}
}
